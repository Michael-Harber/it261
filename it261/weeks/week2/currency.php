...
$total = $ruble_coverter + $pound_converted + $canadian_converted + $euro_converted + $yen_converted;
...
<body>
<div id=wrapper>
<h1>After our world-wind travels we have returned home withe the following currencies</h1>
<ul>
    <li>Rubles</li>
