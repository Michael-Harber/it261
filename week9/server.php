...
// we would like the information that is inputted vie our registration form to land in our database
...
// indtroducing a new function - array_push();
...
if(isset($_POST['login_user'])) {
    ...
    // we counting our errors, and if we have no errors - we will continue the same way
